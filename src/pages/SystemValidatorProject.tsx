        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12 py-14 flex flex-col lg:flex-row items-start gap-10">
          ...
          <div className="lg:w-1/2 z-10">
            ...
            <p className="text-white/55 text-sm mb-2 max-w-md leading-relaxed">
              A growing collection of Claude Code skills — composable building blocks for agentic workflows, automated QA, and developer tooling.
            </p>
            <p className="text-white/55 text-sm mb-6 max-w-md leading-relaxed">
              ...
              orchestrates a five-agent QA pipeline, and{' '}
              <code className="text-amber-300 font-mono bg-white/5 px-1.5 py-0.5 rounded">/skill-auditor</code>{' '}
              diagnoses coverage gaps after the run — then patches or escalates.
            </p>
